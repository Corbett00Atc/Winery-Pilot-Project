...
<!-- page to add winery account. Will add to database-->
...
<html lang="en">
  	...
  	<body bgcolor="#bfff80">
	    ...
	    %>
  		...
  		<center>
  			<h1>Create a Winery Account </h1>
	    	<img src="${pageContext.servletContext.contextPath}/images/winery.jpg" alt="Image of winery." width="25%" height="25%" border="8">
	    </center>

  		<form action="http://localhost:7070/Pilot/WineryAccount" method="post">
	      <label>Winery Username:</label>
	      <br />
	      <input type="text" name="user" size = 30 />
	      <br />
	      <label>Winery Password:</label>
	      <br />
	    ...
	    <center>
		    <h1>New Winery Account Created!</h1>
	    	<img src="${pageContext.servletContext.contextPath}/images/winery.jpg" alt="Image of winery." width="25%" height="25%" border="8">
		    <p>Submit form again to add another entry or select "home" to return to the homepage.</p>
		</center>

	    <jsp:useBean id='bean' class='andrew.beans.WineryBean' />
	    <jsp:setProperty name='bean' property='wineryUser' value='<%=request.getParameter("user")%>' />
